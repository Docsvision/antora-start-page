...
* xref:installguide::installation.adoc[]
...
.Установка на Linux
****
Инструкция по установке и настройке базовой функциональности на Linux.
...
* xref:install-linux::installation.adoc[]
...
* xref:upgrade:ROOT:index.adoc[Обновление {dv}]
...
* xref:mgmtconsole:admin:config.adoc[]
